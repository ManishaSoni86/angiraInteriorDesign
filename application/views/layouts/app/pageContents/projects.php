<article class="grid_12">
                  ...
                  <!-- Left Pannl Projects List -->
                  
                  <h3 class="color-1">Our Projects</h3>
                  <div class="wrapper">
                    <article class="grid_6 alpha Servc_lftNme">
                      <div class="extra-wrap">
                        <div class="indent-top content-container">
                          <div class="contentFetch">
             <?php foreach ($productsLeftListData as $productsListData_item): ?>
                    <ul class="list-1">
                         <li><a class="link" href="<?php echo base_url();?>/app/Projects/<?php echo $productsListData_item['slug'];?>"><?php echo $productsListData_item['name']; ?></a></li>
                    </ul>
               <?php endforeach ?>
              </div>
                        </div>
          ...
          <?php 
            ...
            <div class="content-container">
                          <div class="contentFetch">      
              <p class="serNe_sngl">
                <a class="serNe_sngl" href="<?php echo base_url();?>/app/Projects/<?php echo $productsListData_itemRght['slug'];?>">
               ...
               <div class="extra-wrap">
                <div class="indent-top">
                  ...
                  <?php $projD = substr($productsListData_itemRght['description'],0,200); echo $projD; ?>...
                    <a href="<?php echo base_url();?>/app/Projects/<?php echo $productsListData_itemRght['slug'];?>" class="serv_prdMr">More</a>
                  </p>
                </div>
                </div>
              </div>
